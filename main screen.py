...
class MainWindow(Gtk.ApplicationWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.array = [[] for _ in range(len(type_jason))]
        ...
        for sublist in self.array:
            ...
            if(sublist!=[]):
                ...
                for regis in sublist:
                    ...
                    detail_label=Gtk.Label(label=str(regis.detail),css_classes=["label"])
    ...
    def delete_widget(self,button):
        ...
        for uplist in self.array:
            ...
            for sublist in uplist:
                ...
                if(regis.description==description and regis.time==s_time and regis.amount==amount):
                    flag=1
